...
/**
 * This class represents the main menu of the To-Do com.spring24.todoapp.List.
 *
 * @author Kiara
 * @version 4.0
 */
...
public class Menu {
    ...
    /**
     * Displays available options  and handles the user input of the To-Do com.spring24.todoapp.List.
     *
     * @param ToDoList An ArrayList of task objects
     * @param idList An ArrayList of taskNumbers
     * @param list com.spring24.todoapp.List object that contains the ArrayList of tasks
     * @param deleteTask com.spring24.todoapp.DeleteTask object that handles the deletion of a task
     * @param addTask   com.spring24.todoapp.AddTask object that handles the creation of a new task
